...
- Mooncakes 版本：`chgttyyr/MoonSpectrum@0.2.2`
- 许可证：Apache-2.0
- 主要语言：MoonBit
...
- Mooncakes：本次变更后按 `moon.mod` 元数据发布为 `chgttyyr/MoonSpectrum@0.2.2`。
...
curl.exe -s -o NUL -w "%{http_code}" https://mooncakes.io/docs/chgttyyr/MoonSpectrum@0.2.2
```
